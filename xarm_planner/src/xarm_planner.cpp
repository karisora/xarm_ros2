...
bool XArmPlanner::planPositionTarget(double x, double y, double z, const std::string& end_effector_link)
{
    bool success = move_group_->setPositionTarget(x, y, z, end_effector_link);
    if (!success)
...
std::string XArmPlanner::getEndEffectorLink() const
{
